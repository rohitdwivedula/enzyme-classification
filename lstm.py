...
ds = pd.read_csv('protein_dataset_cdhit_80.csv')
...
mcp_save = keras.callbacks.callbacks.ModelCheckpoint('lstm_run2.h5', save_best_only=True, monitor='val_accuracy', verbose=1)
